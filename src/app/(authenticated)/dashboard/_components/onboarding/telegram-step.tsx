...
export function TelegramStep({ onBack, onSkip, onComplete }: TelegramStepProps) {
      ...
      <motion.div variants={itemVariants}>
        {telegramLinked ? (
          ...
          <div className="space-y-3 text-center">
            <Button
              // eslint-disable-next-line @typescript-eslint/no-empty-function -- fire-and-forget, onError handles display
              onClick={() => void linkTelegram.mutateAsync().catch(() => {})}
              variant="outline"
              size="lg"
